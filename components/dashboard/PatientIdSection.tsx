  ...
  return (
    <div className='w-full h-full border-2 border-primary-light rounded-2xl bg-gray-50/95 py-5 flex flex-col space-y-6 '>
      ...
      <div className='flex flex-col space-y-6 '>
        ...
        <div className='flex flex-col space-y-3 overflow-y-scroll max-h-[515px] w-full scrollbar-thin scrollbar-thumb-primary-light scrollbar-track-primary-light/20 scrollbar-thumb-rounded-full scrollbar-track-rounded-full scroll-smooth'>
