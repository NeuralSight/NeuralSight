const PASSWORD_REQUIRED_ERR_MSG = 'password is required'
const PASSWORD_LENGTH_ERR_MSG = 'password must be at 8 char long'
const PASSWORD_MISMATCH_ERR_MSG = 'Passwords does not match'
